package com.example.vishal.mypersonlchatapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    List<ChatMessage> messages;//generic type list using POJO class
    ArrayAdapter<ChatMessage> chatMessageArrayAdapter;//generic type array using POJO class array adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ChatMessage chatMessage = new ChatMessage("Rahul",mEdtChat.getText().toString());
        ...
        myRef.addChildEventListener(new ChildEventListener()
        {
            ...
            {
                //messages.clear();
                ChatMessage chatMessage = dataSnapshot.getValue(ChatMessage.class);//type cast.
